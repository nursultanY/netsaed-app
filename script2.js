      ...
      content.innerHTML = `
          <section class="home-section">
              ...
              <div class="button-group">
                  <button class="action-btn" onclick="applyRealWorldExperience()">Apply for Real-World Experience</button>
                  <button class="action-btn" onclick="viewAvailableJobs()">View Available Job Experiences</button>
                  <button class="action-btn" onclick="scheduleMeeting()">Apply for a Meeting with University Faculty</button>
              </div>
      ...
      content.innerHTML = `
          <section class="contact-section">
              ...
              <ul class="contact-list">
                  <li><strong>Email:</strong> <a href="mailto:contact@netsaed.com">contact@netsaed.com</a></li>
